...
function dcs_studio_mission_jsonrpc_JsonRpcServer:stop() end
...
---@return boolean system_exited
function dcs_studio_mission_jsonrpc_JsonRpcServer:teardown(router, reason) end
...
---@field JsonRpcServer dcs_studio_mission.jsonrpc.JsonRpcServer # The native WebSocket/HTTP JSON-RPC server inside the DLL, owned by the Lua state that created it.
...
---@param config table
---@return dcs_studio_mission.jsonrpc.JsonRpcServer server
