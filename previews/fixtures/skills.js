      ...
      skills: [
        {
          ...
          name: "dcs-studio",
          description:
            "How to build, run, debug and publish DCS World mods in a DCS Studio project — manifest format, install roots, mission vs GUI scripting environments, the live bridge console, the Lua debugger, and the publish flow.",
          bundledVersion: "1.0.0",
          status: "not-installed",
        },
        {
          id: "dcs-studio-2",
          name: "dcs-studio (outdated)",
          description: "Same skill shown with an older installed copy — the update path.",
        ...
        {
          id: "dcs-studio-3",
          name: "dcs-studio (current)",
          description: "Installed and matching the bundled version.",
          bundledVersion: "1.0.0",
          installedVersion: "1.0.0",
          status: "up-to-date",
        },
        {
          id: "dcs-studio-4",
          name: "dcs-studio (edited)",
          description: "Installed at the same version but with local edits.",
          bundledVersion: "1.0.0",
          installedVersion: "1.0.0",
          status: "modified",
        },
