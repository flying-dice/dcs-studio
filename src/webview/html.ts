...
// The rest of #51 lives next door in ./panel.ts: `createPanel` +
// `webviewCapabilities` own how a panel is opened, and `disposeWithPanel` owns
// how one is closed. The asset-list half is checked by
