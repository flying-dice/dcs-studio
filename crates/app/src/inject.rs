...
// GameGUI hook) into a DCS Saved Games write dir. This replaces the manual
// crates/dcs-bridge/deploy/deploy.ps1 workflow with in-app commands.
...
/// bridge artifacts this build of the app would install.
#[derive(serde::Serialize)]
