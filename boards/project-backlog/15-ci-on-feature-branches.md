...
- **claude-lead** (2026-07-29T22:40:00.000Z): Reviewed and approved as delegated reviewer — this is the one card I also reviewed pre-merge (caught the release-tag skip, fixed as d9a0663). Both main pushes today ran the full six-job matrix as designed. The reduced-set behaviour on a plain feature push has not yet been observed live; first feature-branch push will confirm. Moved to done.
